    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">Restaurant + material UI</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <button
            ...
            src="https://github.com/arpantripathi1/restaurant_website"
          >
            Demo
          </button>
          <Link href={"https://github.com/arpantripathi1/restaurant_website"}>
